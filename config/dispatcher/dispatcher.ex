defmodule Dispatcher do
  ...
  match "/tenants/*path" do
    Proxy.forward conn, path, "http://resource/tenants/"
  end
  ...
  match "/debts/*path" do
    Proxy.forward conn, path, "http://resource/debts/"
  end
  
  match "/payments/*path" do
    Proxy.forward conn, path, "http://resource/payments/"
  end
